...
{
    default String load(String itemId, ItemType type)
    {
        return load(itemId, type, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String load(String itemId, ItemType type, java.util.Map<String, String> context)
    {
        return _iceI_loadAsync(itemId, type, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> loadAsync(String itemId, ItemType type)
    {
        return _iceI_loadAsync(itemId, type, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> loadAsync(String itemId, ItemType type, java.util.Map<String, String> context)
    {
        return _iceI_loadAsync(itemId, type, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_loadAsync(String iceP_itemId, ItemType iceP_type, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "load", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_itemId);
