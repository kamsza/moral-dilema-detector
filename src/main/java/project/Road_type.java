...
public interface Road_type extends Location {
    ...
    /* ***************************************************
     * Property http://webprotege.stanford.edu/project/BDGSqwMbfBgw7pUJ8IOnJ1#lanes_lu_num
     */
     
    /**
     * Gets all property values for the lanes_lu_num property.<p>
     * 
     * @returns a collection of values for the lanes_lu_num property.
     */
    Collection<? extends Integer> getLanes_lu_num();

    /**
     * Checks if the class has a lanes_lu_num property value.<p>
     * 
     * @return true if there is a lanes_lu_num property value.
     */
    boolean hasLanes_lu_num();

    /**
     * Adds a lanes_lu_num property value.<p>
     * 
     * @param newLanes_lu_num the lanes_lu_num property value to be added
     */
    void addLanes_lu_num(Integer newLanes_lu_num);

    /**
     * Removes a lanes_lu_num property value.<p>
     * 
     * @param oldLanes_lu_num the lanes_lu_num property value to be removed.
     */
    void removeLanes_lu_num(Integer oldLanes_lu_num);



    /* ***************************************************
     * Property http://webprotege.stanford.edu/project/BDGSqwMbfBgw7pUJ8IOnJ1#lanes_num
     */
     
    /**
     * Gets all property values for the lanes_num property.<p>
     * 
     * @returns a collection of values for the lanes_num property.
     */
    Collection<? extends Integer> getLanes_num();

    /**
     * Checks if the class has a lanes_num property value.<p>
     * 
     * @return true if there is a lanes_num property value.
     */
    boolean hasLanes_num();

    /**
     * Adds a lanes_num property value.<p>
     * 
     * @param newLanes_num the lanes_num property value to be added
     */
    void addLanes_num(Integer newLanes_num);

    /**
     * Removes a lanes_num property value.<p>
     * 
     * @param oldLanes_num the lanes_num property value to be removed.
     */
    void removeLanes_num(Integer oldLanes_num);



    /* ***************************************************
     * Property http://webprotege.stanford.edu/project/BDGSqwMbfBgw7pUJ8IOnJ1#lanes_rd_num
     */
     
    /**
     * Gets all property values for the lanes_rd_num property.<p>
     * 
     * @returns a collection of values for the lanes_rd_num property.
     */
    Collection<? extends Integer> getLanes_rd_num();

    /**
     * Checks if the class has a lanes_rd_num property value.<p>
     * 
     * @return true if there is a lanes_rd_num property value.
     */
    boolean hasLanes_rd_num();

    /**
     * Adds a lanes_rd_num property value.<p>
     * 
     * @param newLanes_rd_num the lanes_rd_num property value to be added
     */
    void addLanes_rd_num(Integer newLanes_rd_num);

    /**
     * Removes a lanes_rd_num property value.<p>
     * 
     * @param oldLanes_rd_num the lanes_rd_num property value to be removed.
     */
    void removeLanes_rd_num(Integer oldLanes_rd_num);
