...
public class DefaultEmergency_lane extends WrappedIndividualImpl implements Emergency_lane {
    ...
    public Collection<? extends Integer> getAccelerationX() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_ACCELERATIONX, Integer.class);
    }
    ...
    public void addAccelerationX(Integer newAccelerationX) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_ACCELERATIONX, newAccelerationX);
    }

    public void removeAccelerationX(Integer oldAccelerationX) {
    ...
    public Collection<? extends Integer> getAccelerationY() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_ACCELERATIONY, Integer.class);
    }
    ...
    public void addAccelerationY(Integer newAccelerationY) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_ACCELERATIONY, newAccelerationY);
    }

    public void removeAccelerationY(Integer oldAccelerationY) {
    ...
    public Collection<? extends Integer> getDistance() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_DISTANCE, Integer.class);
    }
    ...
    public void removeDistance(Integer oldDistance) {
    ...
    public Collection<? extends Integer> getSpeedX() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SPEEDX, Integer.class);
    }
    ...
    public Collection<? extends Integer> getSpeedY() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SPEEDY, Integer.class);
    }
    ...
    public Collection<? extends Integer> getWidth() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_WIDTH, Integer.class);
    }
