...
import DilemmaDetector.Modules.LightlyInjuredModule;
import DilemmaDetector.Modules.SeverelyInjuredModule;
...
public class FullSimulation {
    ...
    public ReturnContainer doEveryThing() throws OWLOntologyCreationException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
...
//;
        ...
        String pictureName = Visualization.generateImageAndGetName(scenarioModel);
...
//            scenarioModel.export();
        ...
        ReturnContainer returnContainer = new ReturnContainer(collidedEntities, pictureName, consequenceContainer);
